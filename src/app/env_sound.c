...
s32 D_8034EF24 = 0;
s32 D_8034EF28 = 0;
s32 sEnvSoundIsInit = FALSE;
s32 sEnvSoundModelIdLookup[28] = { 0x0D, 0x0E, 0x2A, 0x25, 0x29, 0x0D, 0x40, 0x41, 0x14, 0x47, 0x21, 0x07, 0x21, 0x21,
                                   0x21, 0x21, 0x21, 0x21, 0x2F, 0x2F, 0x2F, 0x6B, 0x6B, 0x6B, 0x6B, 0x51, 0x6B, 0x00 };

EventCallbackInfo sEnvSoundEventCb;
EnvSoundState sEnvSoundState;
f32 sEnvSoundFutureTime; // time set +4 seconds, only set
u8 sEnvSoundStateCount[20];
