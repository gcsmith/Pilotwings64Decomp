...
s16 D_8034EE30[VEHICLE_COUNT][PILOT_COUNT] = {
    ...
    { MODEL_CANNONB_LARK_LAUNCHED, MODEL_CANNONB_GOOSE_LAUNCHED, MODEL_CANNONB_HAWK_LAUNCHED, MODEL_CANNONB_KIWI_LAUNCHED, MODEL_CANNONB_IBIS_LAUNCHED, MODEL_CANNONB_ROBIN_LAUNCHED },
