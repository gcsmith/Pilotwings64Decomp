...
s32 func_8022E2D4(s32 arg0) { return arg0; }
...
void Thread_Kernel(void *arg) {
  ...
  osCreateThread(&gRenderThread, 0, Thread_Render, NULL, gRenderThreadStack,
                 OS_PRIORITY_RMON);
...
void _uvDMA(void *vAddr, u32 devAddr, u32 nbytes) {
  ...
  if (gNmiAsserted == 0) {
    ...
    osPiStartDma(&gPiDmaBlockReq, 0, 0, devAddr, (void *)dest, nbytes,
                 &gPiDmaQ);
