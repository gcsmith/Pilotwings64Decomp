...
// #pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_Copy.s")
...
// #pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat3_Copy.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_Init.s")
...
// #pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_SetIdentity.s")
...
// #pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_SetUnk1.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_MultOp1.s")
void Mat4_MultOp1(Mtx4F_t m_dst, Mtx4F_t mat1, Mtx4F_t mat2) {
  ...
  (pmat)[0][0] = mat1[0][0] * mat2[0][0] + mat1[0][1] * mat2[1][0] +
                 mat1[0][2] * mat2[2][0] + mat1[0][3] * mat2[3][0];
  (pmat)[0][1] = mat1[0][0] * mat2[0][1] + mat1[0][1] * mat2[1][1] +
                 mat1[0][2] * mat2[2][1] + mat1[0][3] * mat2[3][1];
  (pmat)[0][2] = mat1[0][0] * mat2[0][2] + mat1[0][1] * mat2[1][2] +
                 mat1[0][2] * mat2[2][2] + mat1[0][3] * mat2[3][2];
  (pmat)[0][3] = mat1[0][0] * mat2[0][3] + mat1[0][1] * mat2[1][3] +
                 mat1[0][2] * mat2[2][3] + mat1[0][3] * mat2[3][3];
  (pmat)[1][0] = mat1[1][0] * mat2[0][0] + mat1[1][1] * mat2[1][0] +
                 mat1[1][2] * mat2[2][0] + mat1[1][3] * mat2[3][0];
  (pmat)[1][1] = mat1[1][0] * mat2[0][1] + mat1[1][1] * mat2[1][1] +
                 mat1[1][2] * mat2[2][1] + mat1[1][3] * mat2[3][1];
  (pmat)[1][2] = mat1[1][0] * mat2[0][2] + mat1[1][1] * mat2[1][2] +
                 mat1[1][2] * mat2[2][2] + mat1[1][3] * mat2[3][2];
  (pmat)[1][3] = mat1[1][0] * mat2[0][3] + mat1[1][1] * mat2[1][3] +
                 mat1[1][2] * mat2[2][3] + mat1[1][3] * mat2[3][3];
  (pmat)[2][0] = mat1[2][0] * mat2[0][0] + mat1[2][1] * mat2[1][0] +
                 mat1[2][2] * mat2[2][0] + mat1[2][3] * mat2[3][0];
  (pmat)[2][1] = mat1[2][0] * mat2[0][1] + mat1[2][1] * mat2[1][1] +
                 mat1[2][2] * mat2[2][1] + mat1[2][3] * mat2[3][1];
  (pmat)[2][2] = mat1[2][0] * mat2[0][2] + mat1[2][1] * mat2[1][2] +
                 mat1[2][2] * mat2[2][2] + mat1[2][3] * mat2[3][2];
  (pmat)[2][3] = mat1[2][0] * mat2[0][3] + mat1[2][1] * mat2[1][3] +
                 mat1[2][2] * mat2[2][3] + mat1[2][3] * mat2[3][3];
  (pmat)[3][0] = mat1[3][0] * mat2[0][0] + mat1[3][1] * mat2[1][0] +
                 mat1[3][2] * mat2[2][0] + mat1[3][3] * mat2[3][0];
  (pmat)[3][1] = mat1[3][0] * mat2[0][1] + mat1[3][1] * mat2[1][1] +
                 mat1[3][2] * mat2[2][1] + mat1[3][3] * mat2[3][1];
  (pmat)[3][2] = mat1[3][0] * mat2[0][2] + mat1[3][1] * mat2[1][2] +
                 mat1[3][2] * mat2[2][2] + mat1[3][3] * mat2[3][2];
  (pmat)[3][3] = mat1[3][0] * mat2[0][3] + mat1[3][1] * mat2[1][3] +
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_MultOp2.s")
void Mat4_MultOp2(Mtx4F_t m_dst, Mtx4F_t mat1, Mtx4F_t mat2) {
  ...
  (pmat)[0][0] = mat2[0][0] * mat1[0][0] + mat2[0][1] * mat1[1][0] +
                 mat2[0][2] * mat1[2][0] + mat2[0][3] * mat1[3][0];
  (pmat)[0][1] = mat2[0][0] * mat1[0][1] + mat2[0][1] * mat1[1][1] +
                 mat2[0][2] * mat1[2][1] + mat2[0][3] * mat1[3][1];
  (pmat)[0][2] = mat2[0][0] * mat1[0][2] + mat2[0][1] * mat1[1][2] +
                 mat2[0][2] * mat1[2][2] + mat2[0][3] * mat1[3][2];
  (pmat)[0][3] = mat2[0][0] * mat1[0][3] + mat2[0][1] * mat1[1][3] +
                 mat2[0][2] * mat1[2][3] + mat2[0][3] * mat1[3][3];
  (pmat)[1][0] = mat2[1][0] * mat1[0][0] + mat2[1][1] * mat1[1][0] +
                 mat2[1][2] * mat1[2][0] + mat2[1][3] * mat1[3][0];
  (pmat)[1][1] = mat2[1][0] * mat1[0][1] + mat2[1][1] * mat1[1][1] +
                 mat2[1][2] * mat1[2][1] + mat2[1][3] * mat1[3][1];
  (pmat)[1][2] = mat2[1][0] * mat1[0][2] + mat2[1][1] * mat1[1][2] +
                 mat2[1][2] * mat1[2][2] + mat2[1][3] * mat1[3][2];
  (pmat)[1][3] = mat2[1][0] * mat1[0][3] + mat2[1][1] * mat1[1][3] +
                 mat2[1][2] * mat1[2][3] + mat2[1][3] * mat1[3][3];
  (pmat)[2][0] = mat2[2][0] * mat1[0][0] + mat2[2][1] * mat1[1][0] +
                 mat2[2][2] * mat1[2][0] + mat2[2][3] * mat1[3][0];
  (pmat)[2][1] = mat2[2][0] * mat1[0][1] + mat2[2][1] * mat1[1][1] +
                 mat2[2][2] * mat1[2][1] + mat2[2][3] * mat1[3][1];
  (pmat)[2][2] = mat2[2][0] * mat1[0][2] + mat2[2][1] * mat1[1][2] +
                 mat2[2][2] * mat1[2][2] + mat2[2][3] * mat1[3][2];
  (pmat)[2][3] = mat2[2][0] * mat1[0][3] + mat2[2][1] * mat1[1][3] +
                 mat2[2][2] * mat1[2][3] + mat2[2][3] * mat1[3][3];
  (pmat)[3][0] = mat2[3][0] * mat1[0][0] + mat2[3][1] * mat1[1][0] +
                 mat2[3][2] * mat1[2][0] + mat2[3][3] * mat1[3][0];
  (pmat)[3][1] = mat2[3][0] * mat1[0][1] + mat2[3][1] * mat1[1][1] +
                 mat2[3][2] * mat1[2][1] + mat2[3][3] * mat1[3][1];
  (pmat)[3][2] = mat2[3][0] * mat1[0][2] + mat2[3][1] * mat1[1][2] +
                 mat2[3][2] * mat1[2][2] + mat2[3][3] * mat1[3][2];
  (pmat)[3][3] = mat2[3][0] * mat1[0][3] + mat2[3][1] * mat1[1][3] +
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_UnkOp1.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_UnkOp2.s")
void Mat4_UnkOp2(Mtx4F_t mat, float arg1, float arg2, float arg3) {
  ...
  tmpmat[2][3] = mat[2][3];
  tmpmat[3][0] =
      (arg1 * mat[0][0]) + (arg2 * mat[1][0]) + (arg3 * mat[2][0]) + mat[3][0];
  tmpmat[3][1] =
      (arg1 * mat[0][1]) + (arg2 * mat[1][1]) + (arg3 * mat[2][1]) + mat[3][1];
  tmpmat[3][2] =
      (arg1 * mat[0][2]) + (arg2 * mat[1][2]) + (arg3 * mat[2][2]) + mat[3][2];
  tmpmat[3][3] =
      (arg1 * mat[0][3]) + (arg2 * mat[1][3]) + (arg3 * mat[2][3]) + mat[3][3];
  Mat4_Copy(mat, tmpmat);
}

//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_UnkOp3.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_UnkOp5.s")
void Mat4_UnkOp5(Mtx4F_t mat, Vec3F_t *vec1, Vec3F_t *vec2) {
  float x = vec2->x;
  float y = vec2->y;
  float z = vec2->z;
  vec1->x = x * mat[0][0] + y * mat[1][0] + z * mat[2][0] + mat[3][0];
  vec1->y = x * mat[0][1] + y * mat[1][1] + z * mat[2][1] + mat[3][1];
  vec1->z = x * mat[0][2] + y * mat[1][2] + z * mat[2][2] + mat[3][2];
}

#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/func_80229AA0.s")

//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_SetUnk2.s")
void Mat4_SetUnk2(Mtx4F_t mat, float arg1, float arg2, float arg3, float arg4,
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_SetUnk3.s")
...
//#pragma GLOBAL_ASM("asm/nonmatchings/kernel/matrix/Mat4_SetUnk4.s")
