...
void _uvScCreateScheduler(OSSched *sc, void *stack, s32 priority, u8 mode,
                          u8 numFields) {
...
OSMesgQueue *_uvScGetCmdQ(OSSched *s) { return &s->cmdQ; }
...
void func_8022BEB8(s32 arg0) { D_802B9C88 = arg0; }
