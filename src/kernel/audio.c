...
void uvSysInitAudio(void) {
    ...
    if (D_802611B8.fxType == AL_FX_CUSTOM) {
        s32 params[] = {
            8,      5200,   0,       1600,    9830,    -9830,  3000, 0,      0,      0,      64,     3600,    9830,    -9830, 2000,   0, 0,
            0x5000, 0x290,  0x800,   0x4000,  -0x4000, 0x23D6, 0,    0,      0,      0x2D0,  0x670,  0x2000,  -0x2000, 0,     0,      0, 0,
            0xA20,  0x11A0, 0x4000,  -0x4000, 0x23D6,  0,      0,    0x6000, 0xA60,  0xEE0,  0x2000, -0x2000, 0,       0,     0,      0, 0xEE0,
            0x10C0, 0x2000, -0x2000, 0,       0,       0,      0,    0,      0x12B0, 0x4650, 0,      0,       0,       0,     0x7000,
        };
        D_802611B8.params = params;
    }
    {
        ALSeqFile sp40;
