...
void uvDobjModel(s32 objId, s32 mdlId) {
    ...
    if (mdlId == 0xFFFF) {
        temp_t0 = uvmd_array[var_t2->unk0]->mtx_count;
        ...
        var_t2->unk3C = 0;
        var_t2->unk38 = uvmd_array[mdlId]->unk1C;

        if (var_t2->unk0 == 0xFFFF) {
            temp_t0 = 0;
        } else {
            if (uvmd_array[var_t2->unk0] != NULL) {
                temp_t0 = uvmd_array[var_t2->unk0]->mtx_count;
            } else {
                temp_t0 = 0;
                j = -1;
        ...
        var_a3_2 = uvmd_array[mdlId]->mtx_count;
        ...
        for (i = 0; i < var_a3_2; i++) {
            uvMat4Copy(&D_80265080[var_t2->unk2[i]], (u32)uvmd_array[mdlId]->mtx + i * sizeof(Mtx4F));
        }
        var_t2->unk0 = mdlId;
        var_t2->unk34 = 3;
    }
...
void uvDobjPosm(s32 objId, s32 part, Mtx4F* src) {
    ...
    uvmd = gGfxUnkPtrs->models[temp_v0->unk0];
    if (uvmd == NULL) {
...
void uvDobjGetPosm(s32 objId, s32 arg1, Mtx4F* dst) {
    ...
    uvmd = gGfxUnkPtrs->models[sp24->unk0];
    if (arg1 == 0) {
        if (uvmd->unk20 != 1.0f) {
...
void _uvDobjsDraw(UnkStruct_80204D94* arg0, s32 arg1) {
    ...
    for (i = 0; i < 100; i++) {
        ...
        uvmd = gGfxUnkPtrs->models[var_s2->unk0];
        if (uvmd == NULL) {
        ...
        if ((temp_fv0_2 < (arg0->unk1FC + temp_fv1)) && (func_80206F64(arg0->unk2E0, temp_fs1, temp_fs2, temp_fs0, temp_fv1) != 0)) {
            if (arg0->unk204 == 1.0f) {
                var_v1 = uvDobjGetLODIndex(uvmd, temp_fv0_2);
            } else {
                var_v1 = uvDobjGetLODIndex(uvmd, arg0->unk204 * temp_fv0_2);
            }
            if (var_v1 == 0xFF) {
                continue;
            }
            if (arg1 != 0) {
                uvDobj_80217B4C(var_s2, uvmd, var_v1);
            } else if (uvmd->lod[var_v1].billboard != 0) {
                if (uvmd->unk11 & 1) {
                    var_a0 = 3;
                } else {
                    var_a0 = -3;
...
void uvDobj_8021771C(UnkStruct_80204D94* arg0) {
    ...
    for (i = 0; i < D_80269F0A; i++) {
        ...
        if (arg0->unk204 == 1.0f) {
            var_v0 = uvDobjGetLODIndex(uvmd, temp_fv0_2);
        } else {
            var_v0 = uvDobjGetLODIndex(uvmd, arg0->unk204 * temp_fv0_2);
        }
        ...
        if (uvmd->lod[var_v0].billboard != 0) {
            uvDobj_80217E24(temp_s1, uvmd, var_v0, temp_fs3, temp_fs4);
        } else {
            uvDobj_80217B4C(temp_s1, uvmd, var_v0);
        }
...
u8 uvDobjGetLODIndex(ParsedUVMD* uvmd, f32 dist) {
    ...
    lod_radius = uvmd->lod_radius;
    lod_count = uvmd->lod_count;
    if (lod_radius[lod_count - 1] <= dist) {
        return 0xFF;
    }

    for (i = lod_count; i > 0; i--) {
        if (lod_radius[i - 1] < dist) {
            return i;
        }
    }
    return 0;
...
void uvDobj_80217B4C(Unk80263780* arg0, ParsedUVMD* uvmd, u8 arg2) {
...
void uvDobj_80217E24(Unk80263780* arg0, ParsedUVMD* uvmd, u8 arg2, f32 arg3, f32 arg4) {
    uvModelPart* uvmd_part;
    uvModelLOD* uvmd_lod;
    Mtx4F* temp_s7;
    s32 i;
