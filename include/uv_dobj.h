...
enum Models {
    ...
    MODEL_THEMEPARK_BROWN_GREEN_BUILDING                    = 0x004, // Brown+Green Building near carnival | Originally: MODEL_BUILDINGS_NEAR_CARNIVAL
    MODEL_RESORT_TIKI_HUT_1                                 = 0x005, // Tiki Hut / Hay roof building near beach | Originally: MODEL_BUILDINGS_NEAR_BEACH
    MODEL_THEMEPARK_CIRCUS_TENT                             = 0x006, // Yellow/Blue Circus Tent | Originally: MODEL_CIRCUS_TENTS
    MODEL_THEMEPARK_LONG_BUILDING                           = 0x007, // Long building near ferris wheel | Originally: MODEL_BUILDING_WITH_FERRIS_WHEEL
    MODEL_THEMEPARK_SMALL_BUILDING                          = 0x008, // Small building | Originally: MODEL_SMALL_BUILDING
    MODEL_THEMEPARK_MERRY_GO_ROUND                          = 0x009,
    MODEL_CASTLE_ON_PEAK_OF_MAP                             = 0x00A, // Castle on peak of map | Originally: MODEL_CASTLE
    MODEL_THEMEPARK_ENTRY_BUILDING                          = 0x00B, // Three Entry flag building | Originally: MODEL_ENTRY_FLAG_BUILDING
    ...
    MODEL_VILLAGE_LARGE_OLD_BUILDING                        = 0x010, // Old building in small town | Originally: MODEL_OLD_BUILDING_IN_TOWN
    MODEL_VILLAGE_BUILDING_1                                = 0x011, // Originally: MODEL_BUILDING_11
    MODEL_VILLAGE_BUILDING_2                                = 0x012, // And another building | Originally: MODEL_BUILDING_12
    MODEL_RESORT_BUILDING_NEAR_AIRPORT                      = 0x013, // Big white building near airport | Originally: MODEL_BUILDING_NEAR_AIRPORT
    ...
    MODEL_AIRPORT_ATC_BUILDING                              = 0x017, // Aiport ATC building | Originally: MODEL_AIRPORT_ATC
    ...
    MODEL_BARN                                              = 0x01D, // Barn-looking building | Originally: MODEL_BARN
    MODEL_SMALL_FARM_SHACK                                  = 0x01E, // Small white building/shack | Originally: MODEL_SMALL_WHITE_SHACK
    MODEL_YELLOW_N64_FLAG                                   = 0x01F,
    MODEL_RESORT_TIKI_HUT_2                                 = 0x020, // Tiki hut | Originally: MODEL_TIKI_HUT
    MODEL_CARPARK_STREET_LAMP                               = 0x021,
    MODEL_TREE                                              = 0x022,
    MODEL_TREE_SMALL                                        = 0x023, // Smaller tree | Originally: MODEL_SMALLER_TREE
    MODEL_TREE_TALL                                         = 0x024, // Tall tree | Originally: MODEL_TALL_TREE
    ...
    MODEL_RED_WHITE_BLUE_YACHT                              = 0x029, // Red/White/Blue yacht/boat | Originally: MODEL_YACHT_BOATS
    ...
    MODEL_03E                                               = 0x03E,
    MODEL_03F                                               = 0x03F,
    MODEL_WIND_SOCK_YELLOW_BLUE                             = 0x040, // Originally MODEL_40
    ...
    MODEL_MAP_THERMAL_CYLINDER                              = 0x0C7, // Map marker thermal cylinder | Originally: MODEL_HG_WIND_SOCK
    ...
    MODEL_CANNON_ON_TALL_RED_PEDESTAL                        = 0x0CF, // Originally: MODEL_CANON_ON_A_TALL_RED_PEDESTAL
    ...
    MODEL_LANDING_PAD_NOTARGET                              = 0x0D4, // Has no target, just square outline | Originally: MODEL_LANDING_PAD_EMPTY_NO_TARGET
    MODEL_WIND_WAVE_1                                       = 0x0D5, // Wind effect (large wave with scrolling texture | Originally: MODEL_D5
    MODEL_WIND_WAVE_2                                       = 0x0D6, // Smaller wind effect small wave with fast scrolling texture | Originally: MODEL_D6
    MODEL_GREY_WHALE                                        = 0x0D7, // Originally: MODEL_D7
    MODEL_BROWN_BOX                                         = 0x0D8, // Unknown brown rectangular box with missing bottom side
    MODEL_RING_YELLOW_1                                     = 0x0D9, // Rings appear to all have timer modes, presumably hidden when not a timed ring? (can't find any non-timed rings in the list) | Originally: MODEL_FIRST_RING_YELLOW
    ...
    MODEL_LANDING_PAD_1                                     = 0x102, // LPAD | Originally: MODEL_RB_HG_LANDING_PAD
    MODEL_LANDING_PAD_2                                     = 0x103, // LPAD | Originally: MODEL_LANDING_PAD_WITH_RED_TARGET
    ...
    MODEL_HG_SHADOW_COLUMN                                  = 0x112, // Hang glider shadow column model | Originally: MODEL_BREAKS_NO_CLIP
    ...
    MODEL_RB_LARK                                           = 0x11E, // Lark Rocket Pack Model | Originally: MODEL_LARK_RP
    MODEL_RB_SHADOW                                         = 0x11F, // Round Shadow? | Originally: MODEL_ROUND_SHADOW
    MODEL_RB_SHADOW_COLUMN                                  = 0x120, // Shadow Column | Originally: MODEL_SHADOW_COLUMN_RP
    ...
    MODEL_GYRO_LARK                                         = 0x127, // Lark Gyro Model | Originally: MODEL_LARK_GYRO
    ...
    MODEL_GYRO_GOOSE                                        = 0x12B, // Goose Gyro Model | Originally: MODEL_GOOSE_GYRO
    MODEL_GYRO_GOOSE_CRASHED                                = 0x12C, //Goose Gyro Model (crashed)
    MODEL_GYRO_HAWK                                         = 0x12D, // Hawk Gyro Model | Originally: MODEL_HAWK_GYRO
    MODEL_GYRO_HAWK_CRASHED                                 = 0x12E, //Hawk Gyro Model (crashed)
    MODEL_GYRO_KIWI                                         = 0x12F, // Kiwi Gyro Model | Originally: MODEL_KIWI_GYRO
    MODEL_GYRO_KIWI_CRASHED                                 = 0x130, //Kiwi Gyro Model (crashed)
    MODEL_GYRO_IBIS                                         = 0x131, // Ibis Gyro Model | Originally: MODEL_IBIS_GYRO
    MODEL_GYRO_IBIS_CRASHED                                 = 0x132, //Ibis Gyro Model (crashed)
    MODEL_GYRO_ROBIN                                        = 0x133, // Robin Gyro Model | Originally: MODEL_ROBIN_GYRO
    ...
    MODEL_CANNONB_ROBIN_LAUNCHED                            = 0x13A, // Originally: MODEL_13A
    ...
    MODEL_SKYDIVING_KIWI                                    = 0x145, // Skydiving Kiwi model | Originally: MODEL_SKYDIVING_PINK_GIRL
    MODEL_SKYDIVING_IBIS                                    = 0x146, // Skydiving Ibis model | Originally: MODEL_SKYDIVING_ISIS
    MODEL_SKYDIVING_ROBIN                                   = 0x147,
    MODEL_SKYDIVING_SHADOW                                  = 0x148, // Skydiving "shadow" of player | Originally: MODEL_SKYDIVING_SHADOW_OF_PLAYER
    MODEL_SKYDIVING_GOOSE                                   = 0x149,
    MODEL_PARACHUTE_GOOSE                                   = 0x14A,
    MODEL_SKYDIVING_HAWK                                    = 0x14B, // Skydiving Hawk model | Originally: MODEL_SKYDIVING_HAWK_
    MODEL_PARACHUTE_HAWK                                    = 0x14C,
    MODEL_PARACHUTE_KIWI                                    = 0x14D, // Parachute pink girl model | Originally: MODEL_PARACHUTE_PINK_GIRL
    MODEL_PARACHUTE_IBIS                                    = 0x14E, // Parachute Isis model | Originally: MODEL_PARACHUTE_ISIS
    MODEL_PARACHUTE_ROBIN                                   = 0x14F, // Paracute Robin model | Originally: MODEL_PARACUTE_ROBIN
    MODEL_JUMBLEH_LARK                                      = 0x150, // Jumble Hopper Lark | Originally: MODEL_JUMBLE_HOPPER_LARK
    MODEL_JUMBLEH_SHADOW                                    = 0x151, // Round shadow | Originally: MODEL_ROUND_SHADOW2
    MODEL_JUMBLEH_GOOSE                                     = 0x152,
    MODEL_JUMBLEH_HAWK                                      = 0x153,
    MODEL_JUMBLEH_KIWI                                      = 0x154, // Jumble Hopper Kiwi | Originally: MODEL_JUMBLE_HOPPER_KIWI
    MODEL_JUMBLEH_IBIS                                      = 0x155, // Jumble Hopper Ibis | Originally: MODEL_JUMBLE_HOPPER_IBIS
    MODEL_JUMBLEH_ROBIN                                     = 0x156, // Jumble Hopper Robin | Originally: MODEL_JUMBLE_HOPPER_ROBIN
    MODEL_PILOTWINGS_LOGO_FEATHER                           = 0x157, // Pilotwings Swoosh/feather thing | Originally: MODEL_PILOTWINGS_SWOOSH_FEATHER_THING
    MODEL_PILOTWINGS_LOGO_SIX                               = 0x158, // 3D "6" in intro PW64 logo | Originally: MODEL_3D_6_IN_INTRO_PW64_LOGO
    MODEL_PILOTWINGS_LOGO_FOUR                              = 0x159, // 3D "4" in intro PW64 logo | Originally: MODEL_3D_4_IN_INTRO_PW64_LOGO
    ...
    MODEL_LOW_POLY_SKY_CLOUD_DOME_SKYBOX                    = 0x160, // Low-poly Sky+Cloud Dome "skybox" for Intro / Level Select | Originally: MODEL_SKY_CLOUD_DOME_SKYBOX_FOR_INTRO_LEVEL_SELECT
    ...
    MODEL_OCEAN_CUTOUT_CRESCENT_ISLAND                      = 0x166, // Ocean "cut-out" with outline of Crescent Island(?) | Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_CRESCENT_ISLAND
    MODEL_DARK_GLOOMY_CLOUDS_SKYBOX                         = 0x167,
    MODEL_OCEAN_CUTOUT_LITTLE_STATES                        = 0x168, // Ocean "cut-out" with outline of Little States | Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_LITTLE_STATES
    MODEL_OCEAN_CUTOUT_EVER_FROST_ISLAND                    = 0x169, // Ocean "cut-out" with outline of Ever-Frost Island | Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_EVER_FROST_ISLAND
    MODEL_GIANT_CIRCULAR_SKY_OCEAN_SKYBOX                   = 0x16A, // Giant circular sky+ocean skybox with high-resh skybox/clouds AND empty ocean (used in Intro) | Originally: MODEL_CIRCULAR_SKY_OCEAN_SKYBOX_WITH_CLOUDS_EMPTY_OCEAN_IN_INTRO
