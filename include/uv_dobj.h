...
enum Models {
    ...
    MODEL_WHITE_SAIL_BOAT_WITH_RED_LOGO                     = 0x001, // Originally: MODEL_WHITE_SAIL_BOAT
    MODEL_BLUE_CUBOID                                       = 0x002,
    MODEL_YELLOW_SPEED_BOAT                                 = 0x003,
    MODEL_THEMEPARK_BROWN_GREEN_BUILDING                    = 0x004, // Originally: MODEL_BUILDINGS_NEAR_CARNIVAL | Brown+Green Building near carnival
    MODEL_RESORT_TIKI_HUT_1                                 = 0x005, // Originally: MODEL_BUILDINGS_NEAR_BEACH | Tiki Hut / Hay roof building near beach
    MODEL_THEMEPARK_YELLOW_BLUE_TENT                        = 0x006, // Originally: MODEL_CIRCUS_TENTS | Yellow/Blue Circus Tent
    MODEL_THEMEPARK_LONG_BUILDING                           = 0x007, // Originally: MODEL_BUILDING_WITH_FERRIS_WHEEL | Long building near ferris wheel
    MODEL_THEMEPARK_SMALL_BUILDING                          = 0x008, // Originally: MODEL_SMALL_BUILDING | Small building
    MODEL_THEMEPARK_MERRY_GO_ROUND                          = 0x009,
    MODEL_CASTLE_ON_PEAK_OF_MAP                             = 0x00A, // Originally: MODEL_CASTLE | Castle on peak of map
    MODEL_THEMEPARK_ENTRY_BUILDING                          = 0x00B, // Originally: MODEL_ENTRY_FLAG_BUILDING | Three Entry flag building
    ...
    MODEL_VILLAGE_LARGE_OLD_BUILDING                        = 0x010, // Originally: MODEL_OLD_BUILDING_IN_TOWN | Old building in small town
    MODEL_VILLAGE_BUILDING_1                                = 0x011, // Originally: MODEL_BUILDING_11
    MODEL_VILLAGE_BUILDING_2                                = 0x012, // Originally: MODEL_BUILDING_12 | And another building
    MODEL_RESORT_BUILDING_NEAR_AIRPORT                      = 0x013, // Originally: MODEL_BUILDING_NEAR_AIRPORT | Big white building near airport
    MODEL_VILLAGE_BUILDING_WITH_CHIMNEY                     = 0x014, // Originally: MODEL_SMALL_HOUSE_WITH_SMOKE_STACK
    MODEL_LIGHTHOUSE_BUILDING                               = 0x015, // Originally: MODEL_LIGHTHOUSE
    MODEL_CASTLE_YARD                                       = 0x016,
    MODEL_AIRPORT_ATC_BUILDING                              = 0x017, // Originally: MODEL_AIRPORT_ATC | Aiport ATC building
    ...
    MODEL_BARN                                              = 0x01D, // Originally: MODEL_BARN | Barn-looking building
    MODEL_SMALL_FARM_SHACK                                  = 0x01E, // Originally: MODEL_SMALL_WHITE_SHACK | Small white building/shack
    MODEL_YELLOW_N64_FLAG                                   = 0x01F,
    MODEL_RESORT_TIKI_HUT_2                                 = 0x020, // Originally: MODEL_TIKI_HUT | Tiki hut
    MODEL_CARPARK_STREET_LAMP                               = 0x021,
    MODEL_TREE                                              = 0x022,
    MODEL_TREE_SMALL                                        = 0x023, // Originally: MODEL_SMALLER_TREE | Smaller tree
    MODEL_TREE_TALL                                         = 0x024, // Originally: MODEL_TALL_TREE | Tall tree
    ...
    MODEL_RED_WHITE_BLUE_YACHT                              = 0x029, // Originally: MODEL_YACHT_BOATS | Red/White/Blue yacht/boat
    ...
    MODEL_HG_WIND_SOCK                                      = 0x0C7, //Hang glider wind sock
    MODEL_MAP_WIND_INDICATOR_ARROW                          = 0x0C8, //Map marker (wind direction indicator)
    MODEL_MAP_TARGET_INDICATOR_ARROW                        = 0x0C9, //Map marker (Target)
    ...
    MODEL_0CC                                               = 0x0CC, //Map maker?? - Unsure (blue cube)
    MODEL_PILOTWINGS_3D_LOGO                                = 0x0CD, // 0x166184
    MODEL_GREEN_3D_ARROW_THING                              = 0x0CE, //Map marker (Starting location/direction)
    MODEL_CANON_ON_TALL_RED_PEDESTAL                        = 0x0CF, // Originally: MODEL_CANON_ON_A_TALL_RED_PEDESTAL
    MODEL_CANNONB_TARGET_1                                  = 0x0D0, // Target - normal sized, way smaller than 0x106-8
    ...
    MODEL_LANDING_PAD_NOTARGET                              = 0x0D4, // Originally: MODEL_LANDING_PAD_EMPTY_NO_TARGET | Has no target, just square outline
    MODEL_WATER_SCROLLING_1                                 = 0x0D5, // Originally: MODEL_D5 | wavy water with scrolling texture? (maybe air?)
    MODEL_WATER_SCROLLING_2                                 = 0x0D6, // Originally: MODEL_D6 | smaller wavy water with faster scrolling texture?
    MODEL_GREY_WHALE                                        = 0x0D7, // Originally: MODEL_D7
    MODEL_0D8                                               = 0x0D8, // Brown rectangular box with missing bottom side
    MODEL_RING_YELLOW_1                                     = 0x0D9, // Originally: MODEL_FIRST_RING_YELLOW | Rings appear to all have timer modes, presumably hidden when not a timed ring? (can't find any non-timed rings in the list)
    ...
    MODEL_RING_YELLOW_3                                     = 0x0E1, // Originally: MODEL_YELLOW_RING
    MODEL_RING_RED_3                                        = 0x0E2, // Originally: MODEL_RED_RING
    ...
    MODEL_BALL_ORANGE                                       = 0x0F4, // Originally: MODEL_ORANGE_BALL
    MODEL_BALL_GREEN                                        = 0x0F5,
    MODEL_BALL_BLUE                                         = 0x0F6,
    MODEL_MISSILE_TARGET_BILLBOARD                          = 0x0F7, // Originally: MODEL_F7
    MODEL_MISSILE_TARGET_DISC                               = 0x0F8, // Originally: MODEL_F8
    MODEL_MISSILE_TARGET_BALL                               = 0x0F9, // Originally: MODEL_F9
    MODEL_ROCKETP_HOVERPAD_LOCKED                           = 0x0FA, // HPAD
    MODEL_ROCKETP_HOVERPAD_STANDARD                         = 0x0FB, // HPAD
    MODEL_ROCKETP_HOVERPAD_LARGE                            = 0x0FC, // HPAD
    MODEL_GIANT_TRANSPARENT_MECCA_HAWK                      = 0x0FD,
    MODEL_GIANT_RED_THING                                   = 0x0FE, // ??
    MODEL_BIG_ROCK_BOULDER                                  = 0x0FF,
    MODEL_ICEBERG_GIANT                                     = 0x100, // ??
    MODEL_HG_THERMAL_CYLINDER                               = 0x101,
    MODEL_LANDING_PAD_1                                     = 0x102, // Originally: MODEL_RP_HG_LANDING_PAD | LPAD
    MODEL_LANDING_PAD_2                                     = 0x103, // Originally: MODEL_LANDING_PAD_WITH_RED_TARGET | LPAD
    MODEL_LANDING_PAD_3                                     = 0x104, // LPAD
    MODEL_CANNON_ON_PILLAR                                  = 0x105, // Originally: MODEL_105
    ...
    MODEL_HG_GOOSE_LOWPOLY                                  = 0x10B, // Low Poly (LOD?Intro?) | Originally: MODEL_LOW_RES_GOOSE_HG
    MODEL_HG_HAWK_LOWPOLY                                   = 0x10C,
    MODEL_HG_KIWI_LOWPOLY                                   = 0x10D,
    MODEL_HG_IBIS_LOWPOLY                                   = 0x10E,
    MODEL_HG_ROBYN_LOWPOLY                                  = 0x10F,
    MODEL_HG_LARK                                           = 0x110,
    MODEL_HG_SHADOW                                         = 0x111,
    MODEL_HG_SHADOW_COLUMN                                  = 0x112, // Originally: MODEL_BREAKS_NO_CLIP | ???? Breaks NoClip
    MODEL_HG_LARK_CRASHED                                   = 0x113,
    MODEL_HG_GOOSE                                          = 0x114,
    MODEL_HG_GOOSE_CRASHED                                  = 0x115,
    MODEL_HG_HAWK                                           = 0x116,
    MODEL_HG_HAWK_CRASHED                                   = 0x117,
    MODEL_HG_KIWI                                           = 0x118,
    MODEL_HG_KIWI_CRASHED                                   = 0x119,
    MODEL_HG_IBIS                                           = 0x11A,
    MODEL_HG_IBIS_CRASHED                                   = 0x11B,
    MODEL_HG_ROBYN                                          = 0x11C,
    MODEL_HG_ROBYN_CRASHED                                  = 0x11D,
    MODEL_ROCKETP_LARK                                      = 0x11E, // Originally: MODEL_LARK_RP | Lark RP Model
    MODEL_ROCKETP_SHADOW                                    = 0x11F, // Originally: MODEL_ROUND_SHADOW | Round Shadow?
    MODEL_ROCKETP_SHADOW_COLUMN                             = 0x120, // Originally: MODEL_SHADOW_COLUMN_RP | Shadow (Column? RP?)
    MODEL_MULTI_COLORED_CUBE                                = 0x121, // not sure if this is used?
    MODEL_ROCKETP_GOOSE                                     = 0x122,
    MODEL_ROCKETP_HAWK                                      = 0x123,
    MODEL_ROCKETP_KIWI                                      = 0x124,
    MODEL_ROCKETP_IBIS                                      = 0x125,
    MODEL_ROCKETP_ROBYN                                     = 0x126,
    MODEL_GYRO_LARK                                         = 0x127, // Originally: MODEL_LARK_GYRO | Lark Gyro Model
    MODEL_GYRO_SHADOW                                       = 0x128,
    MODEL_GYRO_SHADOW_COLUMN                                = 0x129,
    MODEL_GYRO_LARK_CRASHED                                 = 0x12A,
    MODEL_GYRO_GOOSE                                        = 0x12B, // Originally: MODEL_GOOSE_GYRO | Goose Gyro Model
    MODEL_GYRO_GOOSE_CRASHED                                = 0x12C,
    MODEL_GYRO_HAWK                                         = 0x12D, // Originally: MODEL_HAWK_GYRO | Hawk Gyro Model
    MODEL_GYRO_HAWK_CRASHED                                 = 0x12E,
    MODEL_GYRO_KIWI                                         = 0x12F, // Originally: MODEL_KIWI_GYRO | Kiwi Gyro Model
    MODEL_GYRO_KIWI_CRASHED                                 = 0x130,
    MODEL_GYRO_IBIS                                         = 0x131, // Originally: MODEL_IBIS_GYRO | Ibis Gyro Model
    MODEL_GYRO_IBIS_CRASHED                                 = 0x132,
    MODEL_GYRO_ROBYN                                        = 0x133, // Originally: MODEL_ROBYN_GYRO | Robyn Gyro Model
    MODEL_GYRO_ROBYN_CRASHED                                = 0x134,
    MODEL_CANNONB_LARK_LAUNCHED                             = 0x135, // Originally: MODEL_135
    MODEL_CANNONB_GOOSE_LAUNCHED                            = 0x136, // Originally: MODEL_136
    MODEL_CANNONB_HAWK_LAUNCHED                             = 0x137, // Originally: MODEL_137
    MODEL_CANNONB_KIWI_LAUNCHED                             = 0x138, // Originally: MODEL_138
    MODEL_CANNONB_IBIS_LAUNCHED                             = 0x139, // Originally: MODEL_139
    MODEL_CANNONB_ROBYN_LAUNCHED                            = 0x13A, // Originally: MODEL_13A
    ...
    MODEL_SKYDIVING_KIWI                                    = 0x145, // Originally: MODEL_SKYDIVING_PINK_GIRL | Skydiving pink girl model
    MODEL_SKYDIVING_IBIS                                    = 0x146, // Originally: MODEL_SKYDIVING_ISIS | Skydiving Isis model
    MODEL_SKYDIVING_ROBIN                                   = 0x147,
    MODEL_SKYDIVING_SHADOW                                  = 0x148, // Originally: MODEL_SKYDIVING_SHADOW_OF_PLAYER | Skydiving "shadow" of player
    MODEL_SKYDIVING_GOOSE                                   = 0x149,
    MODEL_PARACHUTE_GOOSE                                   = 0x14A,
    MODEL_SKYDIVING_HAWK                                    = 0x14B, // Originally: MODEL_SKYDIVING_HAWK_ | Skydiving Hawk model
    MODEL_PARACHUTE_HAWK                                    = 0x14C,
    MODEL_PARACHUTE_KIWI                                    = 0x14D, // Originally: MODEL_PARACHUTE_PINK_GIRL | Parachute pink girl model
    MODEL_PARACHUTE_IBIS                                    = 0x14E, // Originally: MODEL_PARACHUTE_ISIS | Parachute Isis model
    MODEL_PARACHUTE_ROBIN                                   = 0x14F, // Originally: MODEL_PARACUTE_ROBIN | Paracute Robin model
    MODEL_JUMBLEH_LARK                                      = 0x150, // Originally: MODEL_JUMBLE_HOPPER_LARK | Jumble Hopper Lark
    MODEL_JUMBLEH_SHADOW                                    = 0x151, // Originally: MODEL_ROUND_SHADOW2 | Round shadow
    MODEL_JUMBLEH_GOOSE                                     = 0x152,
    MODEL_JUMBLEH_HAWK                                      = 0x153,
    MODEL_JUMBLEH_KIWI                                      = 0x154, // Originally: MODEL_JUMBLE_HOPPER_KIWI | Jumble Hopper Kiwi
    MODEL_JUMBLEH_IBIS                                      = 0x155, // Originally: MODEL_JUMBLE_HOPPER_IBIS | Jumble Hopper Ibis
    MODEL_JUMBLEH_ROBYN                                     = 0x156, // Originally: MODEL_JUMBLE_HOPPER_ROBYN | Jumble Hopper Robyn
    MODEL_PILOTWINGS_LOGO_FEATHER                           = 0x157, // Originally: MODEL_PILOTWINGS_SWOOSH_FEATHER_THING | Pilotwings Swoosh/feather thing
    MODEL_PILOTWINGS_LOGO_SIX                               = 0x158, // Originally: MODEL_3D_6_IN_INTRO_PW64_LOGO | 3D "6" in intro PW64 logo
    MODEL_PILOTWINGS_LOGO_FOUR                              = 0x159, // Originally: MODEL_3D_4_IN_INTRO_PW64_LOGO | 3D "4" in intro PW64 logo
    MODEL_LARK_BODY                                         = 0x15A, // Originally: MODEL_LARK_BODY_CHARACTER_SELECT
    ...
    MODEL_LOW_POLY_SKY_CLOUD_DOME_SKYBOX                    = 0x160, // Originally: MODEL_SKY_CLOUD_DOME_SKYBOX_FOR_INTRO_LEVEL_SELECT | Low-poly Sky+Cloud Dome "skybox" for Intro / Level Select
    MODEL_SUNNY_SKYBOX                                      = 0x161,
    MODEL_CLOUDY_SKYBOX                                     = 0x162, // Cloudy Sunny Skybox Part 2? | Originally: MODEL_CLOUDY_SKYBOX_SUNNY_PART_2
    MODEL_DARK_CLOUDS_SKYBOX                                = 0x163,
    MODEL_EVENING_SKYBOX                                    = 0x164,
    MODEL_STARRY_NIGHT_SKYBOX                               = 0x165,
    MODEL_OCEAN_CUTOUT_CRESCENT_ISLAND                      = 0x166, // Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_CRESCENT_ISLAND | Ocean "cut-out" with outline of Crescent Island(?)
    MODEL_DARK_GLOOMY_CLOUDS_SKYBOX                         = 0x167,
    MODEL_OCEAN_CUTOUT_LITTLE_STATES                        = 0x168, // Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_LITTLE_STATES | Ocean "cut-out" with outline of Little States
    MODEL_OCEAN_CUTOUT_EVER_FROST_ISLAND                    = 0x169, // Originally: MODEL_OCEAN_CUT_OUT_WITH_OUTLINE_OF_EVER_FROST_ISLAND | Ocean "cut-out" with outline of Ever-Frost Island
    MODEL_GIANT_CIRCULAR_SKY_OCEAN_SKYBOX                   = 0x16A, // Originally: MODEL_CIRCULAR_SKY_OCEAN_SKYBOX_WITH_CLOUDS_EMPTY_OCEAN_IN_INTRO | Giant circular sky+ocean skybox with high-resh skybox/clouds AND empty ocean (used in Intro)
